...
export default function FilmGrid({ entries }: Props) {
  ...
  return (
    <>
      ...
      {/* Video Modal */}
      {activeVideo && (
        <div className="fixed inset-0 z-[200] bg-black/95 flex items-center justify-center" onClick={closeVideo}>
          <button className="absolute top-6 right-8 z-[201] text-white/60 hover:text-white text-3xl font-light" onClick={closeVideo}>&times;</button>
          ...
          {videoLoading && !videoError && (
            <div className="flex flex-col items-center gap-4">
              ...
              <span className="text-xs font-light tracking-[0.15em] text-white/30 uppercase">加载中...</span>
            </div>
          )}
          ...
          <video
            ...
            src={activeVideo.src}
            poster={activeVideo.src.replace(/\.mp4$/i, "-poster.jpg")}
